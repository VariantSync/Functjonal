...
import anonymized.functjonal.functions.FragileFunction;
import anonymized.functjonal.functions.FragileProcedure;
import anonymized.functjonal.functions.FragileSupplier;
import anonymized.functjonal.category.Monoid;
import anonymized.functjonal.category.Semigroup;
...
public class Result<SuccessType, FailureType> {
    ...
    public void match(final Consumer<SuccessType> successCase, final Consumer<FailureType> failureCase) {
        if (isSuccess()) {
